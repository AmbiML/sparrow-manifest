...
- *camkes-tool*:
    seL4's camkes-tool repo with additions to support KataOS services
- *capdl*:
...
1. Clone this project from GitHub. We assume below this lands in a
   top-level directory named "sparrow".
...
2. Rust; at the moment this must be nightly-2021-11-05-x86_64-unknown-linux-gnu (or be
   ...
   model to match what CAmkES uses and this is not supported by stable versions of Rust.
...
To use crates from Sparrow you can reference them from the local repository or
download them from GitHub; e.g. in a Config.toml:
```
kata-os-common = { path = "../system/components/kata-os-common" }
kata-os-common = { "https://github.com/google/AmbiML/sparrow/projects/kata/apps/system/components/kata-os-common" }
```
